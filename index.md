...
| 30 | 4/10   |     Presentation            |       Student Presentation                               |   [Pres2]()    |  [Reverse-Engineering Deep ReLU Networks]() <br> [ Trojaning Attack on Neural Networks]() <br> [Poisoning and Backdooring Contrastive Learning]() <br> [Extracting Training Data from Large Language Models]() <br> [Deep Leakage from Gradients]() <br> [Label-Only Membership Inference Attacks](https://arxiv.org/abs/2007.14321) <br> [Renyi Differential Privacy]() <br> [Large Language Models Can Be Strong Differentially Private Learners]()   |  |
