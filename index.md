...
| 30 | 4/10   |     Presentation            |       Student Presentation                               |   [Pres2]()    |  [Reverse-Engineering Deep ReLU Networks](https://arxiv.org/pdf/1910.00744.pdf) <br> [ Trojaning Attack on Neural Networks](https://docs.lib.purdue.edu/cgi/viewcontent.cgi?article=2782&context=cstech) <br> [Poisoning and Backdooring Contrastive Learning]() <br> [Extracting Training Data from Large Language Models]({https://www.usenix.org/system/files/sec21-carlini-extracting.pdf) <br> [Deep Leakage from Gradients](https://papers.nips.cc/paper/2019/file/60a6c4002cc7b29142def8871531281a-Paper.pdf) <br> [Label-Only Membership Inference Attacks](http://proceedings.mlr.press/v139/choquette-choo21a.html) <br> [Renyi Differential Privacy](https://arxiv.org/pdf/1702.07476.pdf) <br> [Large Language Models Can Be Strong Differentially Private Learners](https://openreview.net/pdf?id=bVuP3ltATMz)   |  |
